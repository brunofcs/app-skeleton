...
(function($) {
  ...
  function Records(obj, settings) {
    ...
    this.getRecord = function(index) {
      return settings.dataset.records[index * settings.dataset.page];
    }
  };
  ...
  function RecordsCount(obj, settings) {
    ...
    this.create = function() {
      ...
      if (recordsShown < recordsQueryCount && settings.features.paginate) {
        ...
        text += "<span class='dynatable-record-bounds'>" + (bounds[0] + 1) + " até " + bounds[1] + "</span> de ";
      } else if (recordsShown === recordsQueryCount && settings.features.paginate) {
        text += recordsShown + " de ";
      }
      text += recordsQueryCount + " " + collection_name;
      if (recordsQueryCount < recordsTotal) {
        text += " (filtrado de um total de " + recordsTotal + " registros)";
      }
  ...
  function Queries(obj, settings) {
    ...
    this.hasQuery = function(name) {
        return name in settings.dataset.queries;
    };
